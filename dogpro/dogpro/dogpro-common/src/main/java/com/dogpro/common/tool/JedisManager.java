...
//	}
	...
	private JedisManager() {
	 ...
	 public static synchronized JedisManager instance(int dbindex) {
	
	 if (null == instance) {
	
	 instance = new JedisManager();
	 instance.init(dbindex);
	 }
	 return instance;
	 }
	...
	public void init(int dbindex) {
        ...
        MaxTotal = Integer.parseInt(packagesMap.get("MAX_ACTIVE").toString());
        MaxIdle =Integer.parseInt(packagesMap.get("redisMaxIdle").toString());
