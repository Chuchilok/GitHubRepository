...
public final class MD5Generator {
	...
	public static final String MD5_16bit(String readyEncryptStr) throws NoSuchAlgorithmException{
		if(readyEncryptStr != null){
			return MD5Generator.MD5_32bit(readyEncryptStr).substring(8, 24);
		}else{
			return null;
		}
	}
	...
	public static final String MD5_64bit(String readyEncryptStr) throws NoSuchAlgorithmException, UnsupportedEncodingException{
		MessageDigest md = MessageDigest.getInstance(ALGORITHM_MD5);
		return Base64.byteArrayToBase64(md.digest(readyEncryptStr.getBytes(UTF_8)));
	}
	
	public static void main(String[] args) {
		try {
			String ss = "123456";
			String md516 = MD5Generator.MD5_16bit(ss);
			System.out.println("16bit-md5:\n" + md516); //
			String md532 = MD5Generator.MD5_32bit(ss);
			String md5321 = MD5Generator.MD5_32bit1(ss);
			String md5322 = MD5Generator.MD5_32bit2(ss);
			...
			String md564 = MD5Generator.MD5_64bit(ss);
