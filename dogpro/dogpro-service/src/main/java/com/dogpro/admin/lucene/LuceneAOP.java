package com.dogpro.admin.lucene;
...
public class LuceneAOP {
	// 新增遛狗地点切点
	@AfterReturning(pointcut = "execution (* com.dogpro.admin.service.impl.dbservice.AdminDogLocationdbServiceImpl.addLocation(..))", returning = "returnValue")
...
//		doglocationIndex.testCreateIndex(dogLocation);
	...
	// 修改遛狗地点切点
	@AfterReturning(pointcut = "execution (* com.dogpro.admin.service.impl.dbservice.AdminDogLocationdbServiceImpl.updateLocation(..))", returning = "returnValue")
...
//		doglocationIndex.testUpdateIndex(dogLocation);
	...
	// 删除遛狗地点切点
	@AfterReturning(pointcut = "execution (* com.dogpro.admin.service.impl.dbservice.AdminDogLocationdbServiceImpl.deleteLocation(..))", returning = "returnValue")
