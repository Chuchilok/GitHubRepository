...
import com.dogpro.service.dbservice.VersionControldbService;
import com.dogpro.service.webapi.VersionControlService;
	...
	public ResultObject checkVersion(ParameterObject paramterObject) {
		...
		try{
			...
			for (VersionControl versionControl : list) {
				...
				msg = "当前最新版本是"+versionControl.getVersionname()+"，点击确认跳转更新页面。";
				flag = 1;
			}
			Map<String, Object> model = new HashMap<String, Object>();
			model.put("msg", msg);
